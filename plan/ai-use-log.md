...
# Entry 24: Iteration 22

Instead of a spin button, can we make it a handle that you have to drag down. It should be like a drag on the handle that will sort of spin the columns slightly, but they will only really start spinning once the handle has completely been pulled down.

# Entry 25: Iteration 23

Move the lever to be next to the actual slot machine, to make it look more like a realistic slot machine. The padding and margining between everything is also very poor. The slot machine should be the center of attention and all the other metadata should be positioned well to the left and easy to see and read for the user. Also use something uinstead of emojis. The emojis suck and look very bad

# Entry 26: Iteration 24

no it should still be like drawings or smthing not like text

# Entry 27: Iteration 25

The text at the bottom keeps changing the width of the overall slot machine div, like the box that surrounds it so then dimensions keep changing depending on the length of the message.

# Entry 28: Iteration 26
